	...
	<div id="container">
		<div id="contents">
			...
			<div id="section2">
				<div id="s2_inner">
					<div class="login">
						<form name="passwordform" action="${path}/deleteCustomerAction.do">
						<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">	
							<table>
								...
								<tr>
									<th colspan="2" >
										회원정보 삭제를 위해 <span style="color:#FF82AA;">${customerID}</span>님의 비밀번호를 입력하세요.
									</th>
								
								</tr>
								<tr>
									<th>* 비밀번호</th>
									<td><input type="password" class="input" name="password" size="15" placeholder="공백없이 15자 이내로 작성" autofocus required></td>
								</tr>
								<tr>
									...
									<div align="center" class="input">
										...
										<input type="button" value="삭제취소" onclick="window.history.back();">
									</div>
								</tr>
							</table>
						</form>
